...
### Phase 0-B
- `src/security/guardian.ts` — Added `cookieCounts` Folder, cookie counting in `analyzeResponseHeaders()`, `getCookieCount()`/`resetCookieCount()` methods
